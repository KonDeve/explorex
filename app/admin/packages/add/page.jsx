...
import { MapPin, Calendar, Users, DollarSign, Building, Plane, Activity, Gift, Plus, Minus, Image, ArrowLeft, Check } from "lucide-react"
...
export default function AddPackagePage() {
  ...
  const handleImageUpload = (e) => {
    ...
    if (files.length > 0) {
      ...
      // Update formData with file names for reference
      ...
      <div className="border-b border-gray-200 px-6 py-4">
        <div className="max-w-[1920px] mx-auto flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Create a comprehensive travel package</p>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-4">
              ...
              {currentStep === 3 && (
                <div className="space-y-6">
                  {/* Accommodation */}
                  <div className="space-y-4">
                    <h3 className="text-lg font-medium text-gray-900">Accommodation Details</h3>
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1.5">Nights Information</label>
                      <input
                        type="text"
                        ...
                        placeholder="6 nights at premium oceanview suite"
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-blue-500 outline-none"
                      />
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1.5">Flight Information</label>
                        <input
                          type="text"
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Additional services and amenities included"
                        className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-blue-500 outline-none"
                      />
                    </div>
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-4 text-gray-600 mb-4">
                  ...
                  <div className="flex items-center gap-1">
                    <Users size={16} />
                    <span className="text-sm">{formData.max_guests || "0"} guests</span>
                  </div>
                </div>
                ...
                {(formData.accommodation.description || formData.accommodation.amenities.some(a => a)) && (
                  <div className="mb-4 p-4 bg-gray-50 rounded-lg">
                    ...
                    {formData.accommodation.amenities.filter(a => a).length > 0 && (
                      <div className="space-y-1">
                        {formData.accommodation.amenities.filter(a => a).slice(0, 3).map((amenity, index) => (
                ...
                {(formData.transportation.description || formData.transportation.amenities.some(a => a)) && (
                  <div className="mb-4 p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                    ...
                    {formData.transportation.description && (
                      <p className="text-sm text-gray-600">{formData.transportation.description}</p>
                    )}
                  </div>
                )}
                ...
                {(formData.activities.tours.some(t => t) || formData.activities.amenities.some(a => a)) && (
                  <div className="mb-4 p-4 bg-gray-50 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <h5 className="font-semibold text-gray-900">Tour Activities</h5>
                    </div>
                    {formData.activities.tours.filter(t => t).length > 0 && (
                      <div className="space-y-1">
                        {formData.activities.tours.filter(t => t).slice(0, 3).map((tour, index) => (
                          <div key={index} className="flex items-center gap-2 text-sm text-gray-600">
                            <Check size={12} className="text-green-500" />
                            {tour}
                          </div>
